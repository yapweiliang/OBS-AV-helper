...
class camera extends EventEmitter {
    ...
    async callAPI(jsonInput, urlOption = SET_INFO) {
        ...
        if (this.apiBusy) {
            ...
            console.warn(DEBUG_PREFIX, `Camera API busy (count=${this.cameraAPIBusyCount})`);
            return false;
        }
        this.apiBusy = true;
    ...
    async shutdownCamera() {
        // updating of UI should be done by server.js
        const e = await this.callAPI(j_camera_sleep);
        return e;        
    }
